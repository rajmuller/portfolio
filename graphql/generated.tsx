...
export type CommentsQuery = { __typename?: 'Query', comments: Array<{ __typename?: 'Comment', name: string, id: string, email: string, comment: string, createdAt: any }> };
...
export type CreateCommentMutation = { __typename?: 'Mutation', createComment?: { __typename?: 'Comment', comment: string, id: string, name: string, stage: Stage, email: string } | null };
...
export type PublishCommentMutation = { __typename?: 'Mutation', publishComment?: { __typename?: 'Comment', comment: string, id: string, name: string, stage: Stage, email: string } | null };
...
export type PostsQuery = { __typename?: 'Query', posts: Array<{ __typename?: 'Post', id: string, title: string, slug: string, excerpt: string, createdAt: any, featuredImage: { __typename?: 'Asset', id: string, url: string }, author?: { __typename?: 'Author', name: string, bio?: string | null, id: string, photo?: { __typename?: 'Asset', id: string, url: string } | null } | null, categories: Array<{ __typename?: 'Category', id: string, name: string, slug: string }> }> };
...
export type SimilarPostsQuery = { __typename?: 'Query', similarPosts: Array<{ __typename?: 'Post', id: string, title: string, slug: string, createdAt: any, featuredImage: { __typename?: 'Asset', url: string } }>, posts: Array<{ __typename?: 'Post', id: string, title: string, slug: string, createdAt: any, featuredImage: { __typename?: 'Asset', url: string } }> };
...
export type PostQuery = { __typename?: 'Query', post?: { __typename?: 'Post', id: string, title: string, slug: string, excerpt: string, createdAt: any, featuredImage: { __typename?: 'Asset', id: string, url: string }, author?: { __typename?: 'Author', name: string, bio?: string | null, id: string, photo?: { __typename?: 'Asset', id: string, url: string } | null } | null, categories: Array<{ __typename?: 'Category', id: string, name: string, slug: string }>, content: { __typename?: 'PostContentRichText', raw: any } } | null };
...
export type FeaturedPostsQuery = { __typename?: 'Query', posts: Array<{ __typename?: 'Post', id: string, title: string, slug: string, excerpt: string, createdAt: any, featuredImage: { __typename?: 'Asset', id: string, url: string }, author?: { __typename?: 'Author', name: string, bio?: string | null, id: string, photo?: { __typename?: 'Asset', id: string, url: string } | null } | null, categories: Array<{ __typename?: 'Category', id: string, name: string, slug: string }> }> };
...
export const PublishCommentDocument = gql`
  ...
  publishComment(to: PUBLISHED, where: {id: $id}) {
    ...
    `;
export type PublishCommentMutationFn = Apollo.MutationFunction<PublishCommentMutation, PublishCommentMutationVariables>;
 ...
 * });
 */
export function usePublishCommentMutation(baseOptions?: Apollo.MutationHookOptions<PublishCommentMutation, PublishCommentMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<PublishCommentMutation, PublishCommentMutationVariables>(PublishCommentDocument, options);
      }
export type PublishCommentMutationHookResult = ReturnType<typeof usePublishCommentMutation>;
export type PublishCommentMutationResult = Apollo.MutationResult<PublishCommentMutation>;
export type PublishCommentMutationOptions = Apollo.BaseMutationOptions<PublishCommentMutation, PublishCommentMutationVariables>;
...
export const SimilarPostsDocument = gql`
    query SimilarPosts($slug: String = "default", $categories: [String!] = ["default"]) {
  similarPosts: posts(
 ...
 * });
 */
export function useSimilarPostsQuery(baseOptions?: Apollo.QueryHookOptions<SimilarPostsQuery, SimilarPostsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<SimilarPostsQuery, SimilarPostsQueryVariables>(SimilarPostsDocument, options);
      }
export function useSimilarPostsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<SimilarPostsQuery, SimilarPostsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<SimilarPostsQuery, SimilarPostsQueryVariables>(SimilarPostsDocument, options);
        }
...
export type SimilarPostsQueryResult = Apollo.QueryResult<SimilarPostsQuery, SimilarPostsQueryVariables>;
...
export const FeaturedPostsDocument = gql`
    query FeaturedPosts($first: Int = 12, $orderBy: PostOrderByInput = createdAt_DESC) {
 ...
 * });
 */
export function useFeaturedPostsQuery(baseOptions?: Apollo.QueryHookOptions<FeaturedPostsQuery, FeaturedPostsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<FeaturedPostsQuery, FeaturedPostsQueryVariables>(FeaturedPostsDocument, options);
      }
export function useFeaturedPostsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<FeaturedPostsQuery, FeaturedPostsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<FeaturedPostsQuery, FeaturedPostsQueryVariables>(FeaturedPostsDocument, options);
        }
...
export type FeaturedPostsQueryResult = Apollo.QueryResult<FeaturedPostsQuery, FeaturedPostsQueryVariables>;
export const GetCategoryPostDocument = gql`
    query GetCategoryPost($slug: String!, $first: Int = 12, $orderBy: PostOrderByInput = createdAt_DESC) {
  postsConnection(
    orderBy: $orderBy
    first: $first
...
/**
 * __useGetCategoryPostQuery__
 *
 * To run a query within a React component, call `useGetCategoryPostQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetCategoryPostQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetCategoryPostQuery({
 *   variables: {
 *      slug: // value for 'slug'
 *      first: // value for 'first'
 *      orderBy: // value for 'orderBy'
 ...
 * });
 */
export function useGetCategoryPostQuery(baseOptions: Apollo.QueryHookOptions<GetCategoryPostQuery, GetCategoryPostQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetCategoryPostQuery, GetCategoryPostQueryVariables>(GetCategoryPostDocument, options);
      }
export function useGetCategoryPostLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetCategoryPostQuery, GetCategoryPostQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetCategoryPostQuery, GetCategoryPostQueryVariables>(GetCategoryPostDocument, options);
        }
export type GetCategoryPostQueryHookResult = ReturnType<typeof useGetCategoryPostQuery>;
export type GetCategoryPostLazyQueryHookResult = ReturnType<typeof useGetCategoryPostLazyQuery>;
export type GetCategoryPostQueryResult = Apollo.QueryResult<GetCategoryPostQuery, GetCategoryPostQueryVariables>;